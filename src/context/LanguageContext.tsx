...
export const dictionary = {
  en: {
    common: {
      ...
      inquirySent: 'Thank you! Your inquiry has been routed directly to Dalong. Expect a preliminary technical and strategic outbound assessment within 12 hours.',
      email: 'dalong@takinbot.com'
    },
    nav: {
      home: 'Home',
      story: 'Philosophy',
      business: 'Three Weapons',
      contact: 'Connect Dalong',
    },
    hero: {
    ...
    philosophy: {
      ...
      col4Desc: 'Dalong personally handles B2B negotiations and technical discussions — no translators, no information loss. Direct communication builds buyer trust and multiplies inquiry conversion rates.',
    },
    divisions: {
    ...
    about: {
      ...
      storyText1: 'takinbot (拓新搏图) is the personal brand of Dalong, a former big-tech full-stack engineer and product designer. Disillusioned by traditional slow, overpriced trading agencies and cookie-cutter SaaS marketing tools, Dalong packed his bags from Shanghai offices and moved directly into automotive filter and manufacturing workshops across China\'s industrial clusters.',
    ...
    contact: {
      title: 'Establish Direct Contact with Dalong',
      ...
      formBtn: 'Submit Profile to Dalong',
      ...
      wechatDesc: 'Scan to add Founder & Engineer Dalong directly to send product catalogs and tooling specifications.',
      whatsappDesc: 'Click or scan to chat directly with Dalong for international logistics and FOB pricing consultation.',
  ...
  zh: {
    common: {
      ...
      submitting: '提交中...',
      success: '意向提交成功',
      inquirySent: '感谢您的信任！您的出海诉求已直接发送给大龙。我们将在 12 小时内为您输出一份初步的技术与出海渠道评估。',
      email: 'dalong@takinbot.com'
    },
    nav: {
      home: '首页',
    ...
    hero: {
      ...
      subtitle: '我是大龙。我曾是互联网大厂的全栈架构师，写过高并发的系统代码。但我选择走出高档写字楼，直接睡进中国制造业产业带的车间厂房里，和工人们一起钻研机械模具与工艺参数。我不做赚模板暴利的“外包商”，我是与您同生共死的“出海技术合伙人”。我们自主研发 Next.js 极速独立站与 AI 内容工作流，把您复杂的 SKU 数字化，直接推送到海外大采购商的面前。用真诚和技术，把利润牢牢留在咱们工厂手里。',
      ctaWork: '了解服务与试点案例',
      ctaContact: '直连技术合伙人',
    ...
    philosophy: {
      ...
      col4Title: '国际化无损沟通',
      col4Desc: '大龙本人直接与海外买家进行英语商务谈判与技术细节答疑。没有非专业业务员的翻译中转与信息损耗，用专业度建立买家的高感信任，锁死询盘订单。',
    },
    divisions: {
      title: '三大出海武器与试点案例',
    ...
    about: {
      ...
      storyText1: 'takinbot (拓新搏图) 是创始人大龙的个人品牌。大龙曾是一名一线互联网大厂的全栈架构师与产品设计师。在看透了传统外贸代理”收费昂贵、效率低下、不懂技术”以及传统广告公司”人海战术、忽悠工厂”的痛点后，他走出高档写字楼，直接睡进了全国制造业产业带的工厂车间。',
      ...
      storyText3: '我们不讲虚伪的行业黑话。我们提供极快的交付速度、纯粹的诚实和生死共存的合伙人关系。从亲自动手绘制高水准的外包装彩盒、手写高吞吐量产品搜索数据库，到直接用流利英语与德国、美国采购商进行长达数小时 of 工程技术答疑，大龙用键盘和镜头，带您的工厂打通全球供应链。',
    },
    contact: {
      title: '直连大龙，开启工厂出海之旅',
      ...
      qqLabel: 'QQ 极速对接',
      wechatDesc: '微信扫码，可直接添加出海合伙人大龙，在线发送您的产品册或模具参数。',
