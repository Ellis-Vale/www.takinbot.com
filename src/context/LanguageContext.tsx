...
export const dictionary = {
  ...
  zh: {
    ...
    about: {
      ...
      storyText1: 'takinbot (拓新搏图) 是创始人图南的个人品牌。Tunan 曾是一名一线互联网大厂的全栈架构师与产品设计师。在看透了传统外贸代理”收费昂贵、效率低下、不懂技术”以及传统广告公司”人海战术、忽悠工厂”的痛点后，他走出高档写字楼，直接睡进了全国制造业产业带的工厂车间。',
      ...
      storyText3: '我们不讲虚伪的行业黑话。我们提供极快的交付速度、纯粹的诚实和生死共存的合伙人关系。从亲自动手绘制高水准的外包装彩盒、手写高吞吐量产品搜索数据库，到直接用流利英语与德国、美国采购商进行长达数小时 of 工程技术答疑，图南用键盘和镜头，带您的工厂打通全球供应链。',
    },
    contact: {
      title: '直连图南，开启工厂出海之旅',
